...
async function main() {
  ...
  console.log('HAS-BOOT:', await ev(`!!window.__DSH_BOOT__`));
  console.log('HAS-COMPOSER:', await ev(`!!document.querySelector('textarea, [contenteditable="true"]')`));
  if (await ev(`!!document.querySelector('.dk-dock')`)) {
